...
namespace FilRougeTestCodeFirst.Data.Migrations
{
    ...
    [Migration("20230221223508_ModificationTableQuiz")]
    partial class ModificationTableQuiz
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FilRouge_Test_CodeFirst.Data.Entity.Quiz", b =>
                {
                    ...
                    b.Property<string>("RecruterIdId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("FilRouge_Test_CodeFirst.Data.Entity.Quiz", b =>
                {
                    ...
                    b.HasOne("Microsoft.AspNetCore.Identity.IdentityUser", "RecruterId")
                        .WithMany()
                        .HasForeignKey("RecruterIdId");
